...
func Update(c *gin.Context) {
	req := new(accountModel.UserUpdateReq)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserUpdateReq)
		if !ok {
			return nil, helper.ReqAssertErr
		}
		_ = c
		...
		if currentRoleSortMin != 1 {
			...
			minRoleSorts, err := accountModel.GetUserMinRoleSortsByIds([]uint{uint(r.ID)}) // 根据userIdID获取用户角色排序最小值
		...
		accountModel.ClearUserInfoCache()
...
func List(c *gin.Context) {
	req := new(accountModel.UserListReq)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserListReq)
		if !ok {
			return nil, helper.ReqAssertErr
		}
		_ = c
		...
		rets := make([]accountModel.User, 0)
		for _, user := range users {
			rets = append(rets, *user)
		}
		count, err := accountModel.UserListCount(r)
		if err != nil {
			return nil, helper.NewMySqlError(fmt.Errorf("获取用户总数失败: " + err.Error()))
		}

		return accountModel.UserListRsp{
			Total: int(count),
			Users: rets,
		}, nil
	})
...
func Delete(c *gin.Context) {
	req := new(accountModel.UserDeleteReq)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserDeleteReq)
		if !ok {
			return nil, helper.ReqAssertErr
		}
		_ = c
		...
		// 根据用户ID获取用户角色排序最小值
		roleMinSortList, err := accountModel.GetUserMinRoleSortsByIds(r.UserIds)
		...
		// 再将用户从MySQL中删除
		err = accountModel.DeleteUsersById(r.UserIds)
		if err != nil {
		...
		if config.Conf.Notice.DefaultNoticeSwitch {
			...
			noticeUsers, err := accountModel.GetRoleUsersByKeyword(keyword)
			if err != nil {
...
func ReSetTotpSecret(c *gin.Context) {
	req := new(accountModel.UserResetTotpSecret)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserResetTotpSecret)
		if !ok {
			return nil, helper.ReqAssertErr
		}
		// 获取当前用户
...
func ChangePwd(c *gin.Context) {
	req := new(accountModel.UserChangePwdReq)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserChangePwdReq)
		if !ok {
			return nil, helper.ReqAssertErr
		}
		_ = c
...
func ChangeUserStatus(c *gin.Context) {
	req := new(accountModel.UserChangeUserStatusReq)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserChangeUserStatusReq)
		if !ok {
			return nil, helper.ReqAssertErr
		}
		_ = c
...
func GetUserInfo(c *gin.Context) {
	req := new(accountModel.UserInfoReq)
	helper.HandleRequest(c, req, func(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
		r, ok := req.(*accountModel.UserInfoReq)
		if !ok {
			return nil, helper.ReqAssertErr
		}
