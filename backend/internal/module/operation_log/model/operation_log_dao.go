...
func (s OperationLogService) SaveOperationLogChannel(olc <-chan *OperationLog) {
	// 只会在线程开启的时候执行一次
...
// List 获取数据列表
func (s OperationLogService) List(req *OperationLogListReq) ([]*OperationLog, error) {
...
// 获取单个用户
func (s OperationLogService) Find(filter map[string]interface{}, data *OperationLog) error {
