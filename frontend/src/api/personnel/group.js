...
export function syncDingTalkDeptsApi(data) {
  return request({
    url: "/api/goldap/sync/syncDingTalkDepts",
    method: "post",
    data
  });
}
...
export function syncWeComDeptsApi(data) {
  return request({
    url: "/api/goldap/sync/syncWeComDepts",
    method: "post",
    data
  });
}
...
export function syncFeiShuDeptsApi(data) {
  return request({
    url: "/api/goldap/sync/syncFeiShuDepts",
    method: "post",
    data
  });
}
...
export function syncOpenLdapDeptsApi(data) {
  return request({
    url: "/api/goldap/sync/syncOpenLdapDepts",
    method: "post",
    data
  });
}
...
export function syncSqlGroups(data) {
  return request({
    url: "/api/goldap/sync/syncSqlGroups",
    method: "post",
    data
  });
}
